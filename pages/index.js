        ...
        <div className={`relative ${data.showCursor && "cursor-none"}`}>
            ...
            <div className="container mx-auto mb-10">
                ...
                <div className="mt-10 laptop:mt-40 p-2 laptop:p-0" ref={aboutRef}>
                    <h1 className="tablet:m-10 text-3xl text-bold">Трішки про мене.</h1>
                    <p className="tablet:m-10 mt-2 text-xl laptop:text-xl w-full laptop:w-4/5">
                        {data.aboutparaHeader}
                    </p>
                    <p className="tablet:m-10 mt-2 text-xl laptop:text-xl w-full laptop:w-4/5">
                        {data.aboutpara}
                    </p>
                    <p className="tablet:m-10 mt-2 text-xl laptop:text-xl w-full laptop:w-4/5">
                        {data.aboutparaSecondChapter}
                    </p>
                    <p className="tablet:m-10 mt-2 text-xl laptop:text-xl w-full laptop:w-4/5">
                        {data.aboutparaLast}
                    </p>
